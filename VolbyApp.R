...
volby <- read.table("https://raw.githubusercontent.com/SamuelHudec/NRSR2016/master/volby16.txt", header=TRUE, quote="\"")
...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      strong("Obrazok v pravo sluzi na interaktivnejsie znazornenie volebnych vysledkou"),
      helpText("Vysvetlovana premenna je zvolena politicka strana vyjadrena v percentach na volebny okrsok"),
    ...
    mainPanel(
      ...
      helpText("Vyznacenim bodov v obrazku vyplnite tabulku nizsie"),
